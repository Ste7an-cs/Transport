...
class ProtocolNode {
 public:
  ...
  ///        内部工作单元(读-分发循环 / handler 消费者)内调用 → kInvalidState
  ///        (等收敛 = 等自己退出,ADR-0005 D6 / RT_LIFECYCLE_005)。
