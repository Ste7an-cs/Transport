...
已交付 **P0–P4**(tag `v0.4.0`–`v0.4.4`);全量 220 tests 全绿。逐条 RT_* 追溯见 SDD §7 追溯矩阵。
...
- **尚未实现(按路线图 P5–P6 推进,勿当作已有):** 五种交互模式精确状态机与 `kFeedback`(TBD-001)、DDS 动态 Subscribe / 判活 QoS、串口自动重连(TBD-005)、结构化 Trace 与丢弃归因集中出口(P5)、性能/容量/两机验收(P6)。
