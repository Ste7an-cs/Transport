...
**状态：** Accepted —— **已全部实施**（2026-08-08）
**日期：** 2026-08-07
**实施：** D1 → #118；D2 / D8 → #119；D4（固定间隔重连）→ #109；D5 → #120；D6 → #121。D3（`closed_`/`start_done_` 保留 `SharedCompletion`）与 D7（析构不做额外工作）为"维持现状"型决策，无需实施票。D9 为纪律条款。
